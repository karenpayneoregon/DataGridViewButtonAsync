...
namespace DataGridViewButtonExample
{
    public class FormDataOperations
    {
        ...
        private List<ContactType> _contactList;
        public List<ContactType> ContactTypeList => _contactList;
        ...
        {
            _contactList = await Operations.LoadContactTypes().ConfigureAwait(false);
        }
        ...
        {
            if (WinFormDialogs.Question($"Remove '{BindingSource.CurrentRow().Field<string>("CompanyName")}'"))
            {
        ...
        public void CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            DataGridViewDisableButtonCell removeButtonCell = (DataGridViewDisableButtonCell)(dgv.Rows[e.RowIndex].Cells[RemoveButtonName]);
        ...
        public void KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (DataGridView.IsValidDataGridViewButton(RemoveButtonName) || DataGridView.IsValidDataGridViewButton(EditButtonName))
                {
        ...
        public void EditCurrentRecoedInDataGridViewFromBindingSource()
        {
            ...
            EditorForm f = new EditorForm(row, _contactList);
            try
            {
